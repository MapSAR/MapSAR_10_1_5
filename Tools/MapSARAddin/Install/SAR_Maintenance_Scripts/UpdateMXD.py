    ...
    for file in files:
        ...
        if 'mxd' in file:
            ...
            for frame in frames:
                ...
                frame.description = 'MapSAR Template v10.1.5'

            mxd.credits = 'Sierra Madre Search & Rescue Team www.smsr.org'
            mxd.summary = 'Mapping Template for Search And Rescue. \n MapSAR Template v10.1.5'
            mxd.description = 'MapSAR wilderness search and rescue GIS data model and related python scripting Copyright (C) 2012  - Jon Pedder & SMSR \
